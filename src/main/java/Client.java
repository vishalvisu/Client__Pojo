...
class SchemaMappings {
    private String schemaMappingsJobCollection;
    private String schemaMappingsJob;
    ...
    public SchemaMappings() {
        SchemaMappingAdditional schemaMappingAdditional = new SchemaMappingAdditional();
        SchemaMappingPublisher schemaMappingPublisher = new SchemaMappingPublisher();
        this.setSchemaMappingsJobCollection("Jobs");
        this.setSchemaMappingsJob("job");
        this.setSchemaMappingsCompany((String)null);
        this.setSchemaMappingsTitle("title");
        this.setSchemaMappingsCity("city");
        this.setSchemaMappingsState("state");
        this.setSchemaMappingsCountry("country");
        this.setSchemaMappingsDescription("description");
        this.setSchemaMappingsURL("url");
        this.setSchemaMappingsZip((String)null);
        this.setSchemaMappingsCategory("category");
        this.setSchemaMappingsDatePosted("date");
        this.setSchemaMappingsRefNumber("referencenumber");
        this.setSchemaMappingsModifiedDate((String)null);
        this.setSchemaMappingsPublishedDate((String)null);
        this.setSchemaMappingsCPCBid("cpc");
        this.setSchemaMappingsType((String)null);
        this.setSchemaMappingAdditional(schemaMappingAdditional);
        this.setSchemaMappingPublisher(schemaMappingPublisher);
    }
...
class Feeds {
    ...
    public Feeds() {
        this.setXmlFeedUrl("https://joveo-samplefeed.s3.amazonaws.com/abhinay/AbSample.xml");
        this.setId((String)null);
        this.setSchemaMappings(new SchemaMappings());
...
class Params {
    ...
    public Params() {
        this.setName("c1");
        this.setCountry("AU");
        this.setExportedName("ex1");
        this.setAdvertiserName("anbc");
        this.setAts("ADP Apply 2 Jobs");
        this.setAtsUrl("www.google.com");
        this.setFrequency("3 hours");
        this.setApplyConvWindow(30);
        this.setTimezone("7afb");
        this.setType("DirectEmployer");
        this.setIndustry("47");
        this.setExcludedPublishers("");
        this.setEndDate("03/31/2023");
        this.setStartDate("03/04/2028");
        this.setMarkdown("");
        List<Feeds> feedList = new ArrayList();
        feedList.add(new Feeds());
        this.setFeeds(feedList);
        this.setSjCreate(false);
        this.setBudgetCap(new BudgetCap());
        List<String> industryList = new ArrayList();
        industryList.add("47");
        this.setIndustries(industryList);
        this.setGloballyExcludedPublishers("");
    }
